...
#define MLX90614_REGISTER_KE_RESERVED 0x2F
...
public:
	...
	// setDeviceType(<type>) configures the types of device for setEmissivity
	// function.
	// <type> can be either:
	//  - MLX90614xAx: single zone
	//  - MLX90614xBx: dual zone
	//  - MLX90614xCx: gradient compensated
	uint8_t setDeviceType(device_types type);
...
private:
	...
	device_types _defaultDeviceType = MLX90614xAx;
	...
	uint8_t I2CReadWord(byte reg, uint16_t *dest);
